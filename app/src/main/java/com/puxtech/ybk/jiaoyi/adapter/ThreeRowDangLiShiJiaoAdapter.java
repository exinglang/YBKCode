...
public class ThreeRowDangLiShiJiaoAdapter extends BaseAdapter {
    ArrayList<HistoryDealData> list;
    Context context;

    public ThreeRowDangLiShiJiaoAdapter(Context context, ArrayList<HistoryDealData> list) {
        super();
...
//        if ((data.getSTATUS().equals("1") || (data.getSTATUS().equals("4")) {
        ...
        viewHolder.tv_6.setText(data.getBS_FLAG_CH());

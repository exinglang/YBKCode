...
import com.puxtech.ybk.jiaoyi.adapter.ThreeRowActionTuoGuanOrderAdapter;
...
public class TradeChaXunTuoGuanChaXun extends BaseTradeActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_trade_tuo_guan_cha_xun);
        TradeHelper.initToolBarWithSubTitleAndFinishIcon(this, getString(R.string.chaxun_tuoguanchaxun), (Toolbar) findViewById(R.id.toolbar), (TextView) findViewById(R.id.tv_toolbar));
        initWidget();
            ...
            protected Boolean doInBackground(Void... params) {
                try {
                    if (requestType == REQUEST_TYPE_INIT) {
                        ...
                        responseData = httpManager.requestTuoGuanOrder();
                    } else if (requestType == REQUEST_TYPE_CHE_DAN) {
                        HttpManagerTrade httpManagerTrade = new HttpManagerTrade(context);
                        responseData = httpManagerTrade.requestTuoGuanOrderCancel(orderId);
            ...
            protected void onPostExecute(Boolean result) {
                ...
                if (0 == responseData.getRetCode()) {
                    ...
                    if (requestType == REQUEST_TYPE_INIT) {
                        ...
                        ArrayList<TuoGuanOrderData> dataArrayList = ((TuoGuanOrderResponseData) responseData).getDataArrayList();
                        ...
                        final ThreeRowActionTuoGuanOrderAdapter adapter = new ThreeRowActionTuoGuanOrderAdapter(context, TradeChaXunTuoGuanChaXun.this, dataArrayList);
                        listview.setAdapter(adapter);
                        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            @Override
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                TuoGuanOrderData item = adapter.getItem(position);
                                LinkedHashMap<String, String> map = TradeHelper.getTuoGuanOrderDetailMap(item);

...
public class ThreeRowDangRiChengJiaoAdapter extends BaseAdapter {
    ArrayList<TodayDealData> list;
    Context context;

    public ThreeRowDangRiChengJiaoAdapter(Context context, ArrayList<TodayDealData> list) {
        super();
    ...
    @Override
    public TodayDealData getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TodayDealData data = list.get(position);

        viewHolder.tv_1.setText(data.getCOMMODITY_NAME());
        viewHolder.tv_2.setText(data.getTRADE_NO());
//                        1-已委托 2-已成交
//                        3-已撤单 4-部分成交
//                        5-部分成交后撤单
//        if ((data.getSTATUS().equals("1") || (data.getSTATUS().equals("4")) {
        ...
        viewHolder.tv_5.setText(data.getBS_FLAG_CH());
        viewHolder.tv_6.setText(data.getTRADE_NO());

package com.puxtech.ybk.jiaoyi.network;
...
public class HttpSender {
    ...
    public String requestJson(byte[] requestData, String publicUrl, String urlType, String property) throws Exception {
//https://IP:PORT/tradeweb_ybk/login/get_valcode.do
//http://vtradeweb.ycmegroup.com:32000/tradeweb/httpXmlServlet?req=get_valcode
        URL url = new URL(publicUrl + "/" + urlType + "/" + property + ".do");
//        URL url= new URL("http://vtradeweb.ycmegroup.com:32000/tradeweb_ybk/login/get_valcode.do");

        if (property.equals("fund_query") || property.equals("heart_beat")) {

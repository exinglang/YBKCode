...
import com.puxtech.ybk.jiaoyi.adapter.ThreeRowActionTiHuoOrderAdapter;
...
public class TradeChaXunTiHuoChaXun extends BaseTradeActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_trade_ti_huo_cha_xun);
        TradeHelper.initToolBarWithSubTitleAndFinishIcon(this, getString(R.string.chaxun_tihuochaxun), (Toolbar) findViewById(R.id.toolbar), (TextView) findViewById(R.id.tv_toolbar));
        initWidget();
            ...
            protected Boolean doInBackground(Void... params) {
                try {
                    if (requestType == REQUEST_TYPE_INIT) {
                        ...
                        responseData = httpManager.requestTiHuoOrder();
                    } else if (requestType == REQUEST_TYPE_CHE_DAN) {
                        HttpManagerTrade httpManagerTrade = new HttpManagerTrade(context);
                        responseData = httpManagerTrade.requestTiHuoOrderCancel(orderId);
            ...
            protected void onPostExecute(Boolean result) {
                ...
                if (0 == responseData.getRetCode()) {
                    ...
                    if (requestType == REQUEST_TYPE_INIT) {
                        ...
                        ArrayList<TiHuoOrderData> dataArrayList = ((TiHuoOrderResponseData) responseData).getDataArrayList();
                        ...
                        final ThreeRowActionTiHuoOrderAdapter adapter = new ThreeRowActionTiHuoOrderAdapter(context, TradeChaXunTiHuoChaXun.this, dataArrayList);
                        listview.setAdapter(adapter);
                        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            @Override
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                TiHuoOrderData item = adapter.getItem(position);
                                LinkedHashMap<String, String> map = TradeHelper.getTiHuoOrderDetailMap(item);
